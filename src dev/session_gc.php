// https://doc.bccnsoft.com/docs/php-docs-7-en/class.sessionhandler.html
https://doc.bccnsoft.com/docs/php-docs-7-en/session.configuration.html#ini.session.gc-maxlifetime
...
https://externals.io/message/94990
...
// my code
class RemoveImageServerSessionHandler extends SessionHandler
{
    private $key;
    ...
    {
        $data = parent::destroy($session_id );
